...
class ApiClient {
    constructor() {
         ...
         * @type {String}
         * @default http://192.168.0.17/api/v1
         */
        this.basePath = 'http://192.168.0.17/api/v1'.replace(/\/+$/, '');
        ...
        this.authentications = {
            ...
            'bearerAuthAdmin': {type: 'bearer'}, // JWT
            'bearerAuthMaster': {type: 'bearer'} // JWT
        }
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "http://192.168.0.17/api/v1",
              'description': "Домашний сервер (не всегда работает)",
            },
            {
              'url': "http://188.225.82.78/api/v1",
