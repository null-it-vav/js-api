...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.MasterApi();
  });
  ...
  describe('MasterApi', function() {
    ...
    describe('clientClientMasterMasterDelete', function() {
      it('should call clientClientMasterMasterDelete successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterMasterDelete
        //instance.clientClientMasterMasterDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientMasterMasterPatch', function() {
      it('should call clientClientMasterMasterPatch successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterMasterPatch
        //instance.clientClientMasterMasterPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientMasterPost', function() {
      it('should call clientClientMasterPost successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterPost
        //instance.clientClientMasterPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
