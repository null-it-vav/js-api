...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.ClientApi();
  });
  ...
  describe('ClientApi', function() {
    ...
    describe('clientClientPatch', function() {
      it('should call clientClientPatch successfully', function(done) {
        //uncomment below and update the code to test clientClientPatch
        //instance.clientClientPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientPost', function() {
      it('should call clientPost successfully', function(done) {
        //uncomment below and update the code to test clientPost
        //instance.clientPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
