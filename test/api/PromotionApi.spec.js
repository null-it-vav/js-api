...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.PromotionApi();
  });
  ...
  describe('PromotionApi', function() {
    ...
    describe('clientClientPromotionPost', function() {
      it('should call clientClientPromotionPost successfully', function(done) {
        //uncomment below and update the code to test clientClientPromotionPost
        //instance.clientClientPromotionPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientPromotionPromotionDelete', function() {
      it('should call clientClientPromotionPromotionDelete successfully', function(done) {
        //uncomment below and update the code to test clientClientPromotionPromotionDelete
        //instance.clientClientPromotionPromotionDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientPromotionPromotionPatch', function() {
      it('should call clientClientPromotionPromotionPatch successfully', function(done) {
        //uncomment below and update the code to test clientClientPromotionPromotionPatch
        //instance.clientClientPromotionPromotionPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
