...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.ServiceApi();
  });
  ...
  describe('ServiceApi', function() {
    ...
    describe('clientClientServicePost', function() {
      it('should call clientClientServicePost successfully', function(done) {
        //uncomment below and update the code to test clientClientServicePost
        //instance.clientClientServicePost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientServiceServiceDelete', function() {
      it('should call clientClientServiceServiceDelete successfully', function(done) {
        //uncomment below and update the code to test clientClientServiceServiceDelete
        //instance.clientClientServiceServiceDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientServiceServicePatch', function() {
      it('should call clientClientServiceServicePatch successfully', function(done) {
        //uncomment below and update the code to test clientClientServiceServicePatch
        //instance.clientClientServiceServicePatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
