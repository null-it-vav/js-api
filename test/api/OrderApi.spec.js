...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.OrderApi();
  });
  ...
  describe('OrderApi', function() {
    describe('clientClientOrderGet', function() {
      it('should call clientClientOrderGet successfully', function(done) {
        //uncomment below and update the code to test clientClientOrderGet
        //instance.clientClientOrderGet(function(error) {
    ...
    describe('clientClientOrderOrderDelete', function() {
      it('should call clientClientOrderOrderDelete successfully', function(done) {
        //uncomment below and update the code to test clientClientOrderOrderDelete
        //instance.clientClientOrderOrderDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientOrderOrderGet', function() {
      it('should call clientClientOrderOrderGet successfully', function(done) {
        //uncomment below and update the code to test clientClientOrderOrderGet
        //instance.clientClientOrderOrderGet(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientOrderOrderPatch', function() {
      it('should call clientClientOrderOrderPatch successfully', function(done) {
        //uncomment below and update the code to test clientClientOrderOrderPatch
        //instance.clientClientOrderOrderPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
