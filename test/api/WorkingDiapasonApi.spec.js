...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.WorkingDiapasonApi();
  });
  ...
  describe('WorkingDiapasonApi', function() {
    ...
    describe('clientClientMasterMasterWorkingDiapasonPost', function() {
      it('should call clientClientMasterMasterWorkingDiapasonPost successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterMasterWorkingDiapasonPost
        //instance.clientClientMasterMasterWorkingDiapasonPost(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientMasterMasterWorkingDiapasonWorkingDiapasonDelete', function() {
      it('should call clientClientMasterMasterWorkingDiapasonWorkingDiapasonDelete successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterMasterWorkingDiapasonWorkingDiapasonDelete
        //instance.clientClientMasterMasterWorkingDiapasonWorkingDiapasonDelete(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('clientClientMasterMasterWorkingDiapasonWorkingDiapasonPatch', function() {
      it('should call clientClientMasterMasterWorkingDiapasonWorkingDiapasonPatch successfully', function(done) {
        //uncomment below and update the code to test clientClientMasterMasterWorkingDiapasonWorkingDiapasonPatch
        //instance.clientClientMasterMasterWorkingDiapasonWorkingDiapasonPatch(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
