...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new GroomerService.WorkingDiapason();
  });
  ...
  describe('WorkingDiapason', function() {
    it('should create an instance of WorkingDiapason', function() {
      // uncomment below and update the code to test WorkingDiapason
      //var instane = new GroomerService.WorkingDiapason();
      //expect(instance).to.be.a(GroomerService.WorkingDiapason);
    });
    ...
    it('should have the property timeStart (base name: "time_start")', function() {
      // uncomment below and update the code to test the property timeStart
      //var instane = new GroomerService.WorkingDiapason();
      //expect(instance).to.be();
    });
